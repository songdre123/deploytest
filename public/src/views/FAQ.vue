<template>
	<section class="bg-base-100 text-black0">
		<div class="container flex flex-col justify-center p-4 mx-auto md:p-8">
			...
			<div class="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 divide-gray-700">
                <div class="flex-col"><h3>Itinerary planner</h3></div>
				<details>
					<summary class="py-2 outline-none cursor-pointer hover:underline">Optio maiores eligendi molestiae totam dolores similique?</summary>
					<div class="px-4 pb-4">
				...
				<details>
					<summary class="py-2 outline-none cursor-pointer hover:underline">Modi dolorem veritatis culpa quos consequuntur beatae itaque excepturi perspiciatis?</summary>
					<div class="px-4 pb-4">
				...
				<details>
					<summary class="py-2 outline-none cursor-pointer hover:underline">Magni reprehenderit possimus debitis?</summary>
